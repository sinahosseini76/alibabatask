                    ...
                    <form action="{{route('category.update', ['category' => $category])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4 mb-5">
                                ...
                                <select class="form-control @error('parent_id') is-invalid @enderror" name="parent_id">
                                    ...
                                    @foreach($categories as $value)
                                        <option value="{{$value->id}}" @if($value->id == $category->id) selected @endif>{{$value->name}} ({{$value->name_fa}})</option>
                                    @endforeach
                                </select>
                                @error('parent_id')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-5">
                                ...
                                <input type="text" class="form-control @error('description') is-invalid @enderror" id="exampleInputText1" name="description" value="{{$category->description}}">
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                     <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-2 mb-5">
                                <div class="form-check form-switch mb-2">
                                    <input type="checkbox" style="cursor: pointer;" class="form-check-input"
                                           ...
                                           value="active" @if($category->status === \Modules\Category\Models\Category::STATUS_ACTIVE) checked @endif>
