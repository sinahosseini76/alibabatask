...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">لیست محصولات</h6>
          <div class="row">
              <div class="col md3" style="text-align: end; float: left;">
                  <a href="{{route('online-menu.category.create')}}" class="btn btn-primary btn-icon-text">
                     افزودن
            ...
            @foreach($categories as $key => $category)
                <tr>
                    ...
                    @if($category->status == \Modules\Category\Models\Category::STATUS_ACTIVE)
                        <td><a href="{{route('online-menu.category.changeStatus', ['category' => $category])}}"><span
                    ...
                    <td>
                        <a href="{{route('online-menu.category.edit', ['category' => $category])}}"><span
  ...
  <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script>
        ...
        function confirmDelete(category) {
            $.ajax({
                url: '/admin/online-menu/category/' + category +'/delete',
                type: 'get',
                headers: {
